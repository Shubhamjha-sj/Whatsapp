...
public class MainActivity extends AppCompatActivity {
  ...
  public void toggleLoginMode(View view ){
    Button loginSignUpButton=(Button)findViewById(R.id.signUpButton);
      ...
      ParseUser.logInInBackground(usernameEditText.getText().toString(), passwordEditText.getText().toString(), new LogInCallback() {
        ...
        public void done(ParseUser user, ParseException e) {
          if(e==null){
            ...
            Toast.makeText(MainActivity.this,message+" Log In unsuccessfull",Toast.LENGTH_SHORT).show();
    ...
    user.signUpInBackground(new SignUpCallback() {
      ...
      public void done(ParseException e) {
        if(e==null)
        {
          ...
          Toast.makeText(MainActivity.this,message+" Sign Up unsuccessfull",Toast.LENGTH_SHORT).show();
